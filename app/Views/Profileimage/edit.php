...
<?= form_open_multipart("/profileimage/update") ?>
    ...
    <div class="field is-grouped mt-4">
        <div class="control">
            <button class="button is-primary is-rounded"><?= lang('Profileimage.upload') ?></button>
        </div>

        <div class="control">
            <a class="button is-rounded" href="<?= site_url("/profile/show") ?>"><?= lang('Profileimage.cancel') ?></a>
        </div>
    </div>
